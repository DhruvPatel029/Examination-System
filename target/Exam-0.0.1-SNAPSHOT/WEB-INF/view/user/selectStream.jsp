...
<body>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<form class="cmxform" method="post" action="loadExam">
										<fieldset>
											<div class="form-group">
												<label for="curl">Select Stream Type</label> 
												<select
													class="form-control" name="streamType" id="streamTypeId"
													required="required">
													<option disabled="disabled" selected="selected">Select
														Stream</option>
													<c:forEach items="${streamTypeList}" var="i">
														<option value="${i.id}">${i.streamType}</option>
													</c:forEach>
												</select>
											</div>
											<input class="bg-primary" type="submit" value="Next">
										</fieldset>
									</form>
								</div>
							</div>
	...
	<script
		src="<%request.getContextPath();%>/adminResources/js/validation/question.js"></script>

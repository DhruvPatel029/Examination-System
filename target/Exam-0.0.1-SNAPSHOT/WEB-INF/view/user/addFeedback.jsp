...
<%-- <link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/adminResources/starcss/star.css">
 --%>
<link rel="stylesheet"
...
<body>
 ...
 -->
											...
											<%-- <div class="form-group">
												<label for="ccomment">Complain Description</label>

...
<body>
				...
				<div class="content-wrapper">
					<div class="row grid-margin">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Perform Exam</h4>
									<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
									<form class="cmxform" id="insertExamForm" method="post">
										<fieldset>
											<c:forEach items="${questionList}" var="i" varStatus="j">

												<div class="form-group">
													<div class="mb-3" id="question"><input id="questionId" type="hidden" value="${i.id}">${j.count}. ${i.examQuestion}</div>
													A. <input type="radio" name="selectedAns${j.count}"
														id="selectedAns${j.count}" value="A" /> <label for="">${i.option1}</label><br>

													B. <input type="radio" name="selectedAns${j.count}"
														id="selectedAns${j.count}" value="B" /> <label for="">${i.option2}
													</label><br> C. <input type="radio"
														name="selectedAns${j.count}" id="selectedAns${j.count}"
														value="C" /> <label for="">${i.option3}</label><br>

													D. <input type="radio" name="selectedAns${j.count}"
														id="selectedAns${j.count}" value="D" /> <label for="">${i.option4}</label>
												</div>
											</c:forEach>
	...
	<script src="<%=request.getContextPath()%>/adminResources/js/submit.js"></script>
	<script

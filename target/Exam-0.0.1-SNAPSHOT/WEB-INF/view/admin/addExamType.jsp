						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<f:form class="cmxform" method="post" action="insertExamType"
										modelAttribute="ExamTypeVO">
										<fieldset>
											<div class="form-group">
												<label for="cname">Exam Type</label>
												<f:input path="examType" class="form-control"
													required="required" />
												<f:hidden path="id" />
												<!--   <input id="cname" class="form-control" name="name"  type="text" required> -->
											</div>
											<div class="form-group">
												<label for="ccomment">Exam Type Description</label>
												<f:textarea rows="3" cols="3" path="examTypeDescription"

		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Exam Type Table</h4>
							<div class="row">
								<div class="col-12">
											...
											<tbody>
												...
												<c:forEach items="${examList}" var="i">
													<tr>
														<td>${i.id}</td>
														<td>${i.examType}</td>
														<td>${i.examTypeDescription}</td>
														<td><a href="editExamType?id=${i.id}"><button type="button"
																		class="btn btn-outline-success btn-fw">Edit</button></a> <a
															href="deleteExamType?id=${i.id}"><button type="button"

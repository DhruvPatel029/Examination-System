...
<head>
  ...
  <title>CG | Add Stream Type</title>
  <!-- plugins:css -->
        ...
        <div class="content-wrapper">
          ...
          <div class="row grid-margin">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">ADD Stream TYPE</h4>
                  
                  <%@taglib uri="http://www.springframework.org/tags/form" prefix="f" %>
                  <f:form class="cmxform"  method="post" action="insertStreamType" modelAttribute="StreamTypeVO">
                     <f:hidden path="id"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="cname">Stream Type</label>
                        <f:input path="streamType" class="form-control" required="required"/>
                       
                       <!--  <input id="cname" class="form-control" name="name" minlength="2" type="text" required> -->
                      </div>
                      <div class="form-group">
                        <label for="ccomment">Stream Type Description</label>
                        <f:textarea rows="3" cols="3" path="streamTypeDescription" class="form-control" required="required"/>

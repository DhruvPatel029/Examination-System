		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Stream Table</h4>
							<div class="row">
								<div class="col-12">
											...
											<tbody>
												<c:forEach items="${streamTypeList}" var="i">
													<tr>
														<td>${i.id}</td>
														<td>${i.streamType}</td>
														<td>${i.streamTypeDescription}</td>
														<td><a href="editStreamType?id=${i.id}"><button
																	type="button" class="btn btn-outline-success btn-fw">Edit</button></a>
															<a href="deleteStreamType?id=${i.id}"><button
																	type="button" class="btn btn-outline-danger btn-fw">Delete</button></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>

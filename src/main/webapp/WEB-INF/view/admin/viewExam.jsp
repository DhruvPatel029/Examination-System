		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">Loan Rate Table</h4>
							<div class="row">
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${examList}" var="i">
													<tr>
														<td>${i.id}</td>
														<td>${i.examTypeVO.examType}</td>
														<td>${i.streamTypeVO.streamType}</td>
														<td>${i.examQuestion}</td>
														<td>${i.option1}</td>
														<td>${i.option2}</td>
														<td>${i.option3}</td>
														<td>${i.option4}</td>
														<td>${i.correctOption}</td>
														<td><a href="editExam?id=${i.id}"><button type="button"
																		class="btn btn-outline-success btn-fw">Edit</button></a><a
															href="deleteExam?id=${i.id}"><button type="button"
																	class="btn btn-outline-danger btn-fw">Delete</button></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>

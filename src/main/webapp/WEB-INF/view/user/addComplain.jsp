...
<body>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<f:form class="cmxform" method="post" action="addcomplaint"
										modelAttribute="ComplainVO" enctype="multipart/form-data">
										<fieldset>
											<div class="form-group">
												<label for="cname">Complain Subject</label>
 ...
 -->
											...
											<div class="form-group">
												<label for="ccomment">Choose file</label> <input
													id="customFile" type="file" class="form-control"
													name="file">
											</div>
